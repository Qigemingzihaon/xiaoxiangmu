  ...
  mysql.query($sql1st, pdpctid,function (err, result) {
    ...
    if (result) {
      ...
      async.each(coll, function (item, callback) {
          // console.log(item)
          mysql.query($sql1stimg, pdpctid, function (err11, namedata) {
